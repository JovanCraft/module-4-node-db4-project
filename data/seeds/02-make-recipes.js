...
const steps = [
    //Broccoli Pesto Pasta
    { step_text: 'Heat pan', step_order_number: 1, recipe_id: 1 },
    { step_text: 'Add broccoli', step_order_number: 2, recipe_id: 1 },
    { step_text: 'Add pesto mixed with pasta', step_order_number: 3, recipe_id: 1 },
    //Lemon Chicken
    { step_text: 'Heat oven', step_order_number: 1, recipe_id: 2 },
    { step_text: 'Put chicken and lemon in oven', step_order_number: 2, recipe_id: 2 },
    { step_text: 'Put in oven at 500 degrees', step_order_number: 3, recipe_id: 2 },
    //Salmon en Papillote
    { step_text: 'Fish a salmon in the Bidasoa river', step_order_number: 1, recipe_id: 3 },
    { step_text: 'Cook salmon', step_order_number: 2, recipe_id: 3 },
]
